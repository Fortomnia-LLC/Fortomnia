  ...
  return (
    <Tabs
      screenOptions={{
        ...
        tabBarStyle: { backgroundColor: "#111111", borderTopColor: "#262626", height: 84, paddingBottom: 20, paddingTop: 8 },
      }}
    >
      <Tabs.Screen name="index" options={{ tabBarIcon: ({ color, focused, size }) => <Ionicons color={color} name={focused ? "home" : "home-outline"} size={size} />, title: "Home" }} />
      <Tabs.Screen name="training" options={{ tabBarIcon: ({ color, focused, size }) => <Ionicons color={color} name={focused ? "barbell" : "barbell-outline"} size={size} />, title: "Training" }} />
      ...
      <Tabs.Screen name="recovery-workout" options={{ href: null }} />
      ...
      <Tabs.Screen name="training-locations" options={{ href: null }} />
