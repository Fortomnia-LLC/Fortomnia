...
export default function CoachQuestionnaireScreen() {
  ...
  async function save() {
    ...
    setSaving(false);
    if (error) setMessage(error.message); else setMessage("Athletic profile saved. Your free training intelligence can use this profile, and premium AI Coach can build on it.");
  }
