...
| Working-template exercise editing | Required | Existing workout-template routes and add-exercise screen provide a partial foundation | Expose a clear **Add exercise** action while editing an existing template; support search/filter, duplicate prevention, ordering, save/cancel behavior, and regression tests without requiring users to create a new template |
