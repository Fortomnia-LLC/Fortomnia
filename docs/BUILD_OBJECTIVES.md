...
| Gym profiles and session equipment | Required | User-level broad and specialty availability exist | Let users save home, gym, hotel, outdoor, and other training locations; maintain equipment inventory and notes per location; choose the active location; and generate/filter sessions from equipment actually available there |
