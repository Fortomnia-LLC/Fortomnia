...
| iPhone and Lock Screen widgets | In progress | WidgetKit Home Screen and Lock Screen target, shared App Group, active-workout progress, next saved workout, active training location, privacy redaction, stale/empty handling, system-limited refresh, and Fortomnia deep links are implemented | Validate the expanded states on physical iPhone/Lock Screen, add explicit next-workout selection/scheduling, then add reminder states |
