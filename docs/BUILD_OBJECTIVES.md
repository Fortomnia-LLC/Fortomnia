...
| Supplement barcode scanning | Required | Supplement tracking and user-owned supplement records already exist; no scanner flow is established | Add permission-aware barcode scanning with manual entry fallback, reliable product matching, editable serving and ingredient facts, provenance, duplicate handling, and safe behavior for unknown or conflicting products |
